         ...
         <div class="modal-dialog">
             <div class="modal-content">
                 ...
                 <div class="modal-body">
                  ...
                  is-invalid
                  @enderror"
                                 name="tahun" placeholder="Masukkan Tahun Dengan Benar">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                     ...
                     @enderror"
                                    ...
                                    placeholder="Masukkan Tahun Dengan Benar">
                       ...
                       is-invalid
                       @enderror"
                                    name="nominal" value ={{ old('nominal',$s->nominal)}} placeholder="Masukkan Nominal Dengan Benar">
         ...
         <div class="modal fade" id="delete{{ $s->id }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
             <div class="modal-dialog">
                 <div class="modal-content">
                     ...
                     <div class="modal-body">
                        <p>Apakah Anda Yakin Ingin Menghapus Data Spp <b>{{$s->tahun}}</b></p>
                     </div>
                             <div class="modal-footer justify-content-between">
                                 <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Keluar</button>
