                             ...
                             <tbody>
                                 ...
                                 @forelse($Kelas as $no => $k)
                                     <tr>
                                         <th scope="row"> {{ ++$no }}</th>
                                         <td>{{ $k->name }}</td>
                                         <td>{{ $k->kopetensi_keahlian }}</td>
                                         <td>
                                             <a href="#" data-bs-toggle="modal"
                                                 data-bs-target="#edit{{ $k->id }}"class="btn btn-secondary btn-sm">Edit</a>
                                             <a href="#" data-bs-toggle="modal"
                                                 data-bs-target=" #delete{{ $k->id }}"class="btn btn-danger btn-sm">Hapus</a>
                                         </td>
         ...
         <div class="modal-dialog">
             <div class="modal-content">
                 ...
                 <div class="modal-body">
                  ...
                  is-invalid
                  @enderror"
                                 name="name" placeholder="Masukkan Nama Kelas Dengan Benar">
                         ...
                         <div class="mb-3">
                             <label class="form-label">Kopetensi</label>
                             <input type="text"
                                 class="form-control @error('kopetensi_keahlian') 
                    is-invalid
                    @enderror"
                                 name="kopetensi_keahlian" placeholder="Masukkan Nama keahlian Dengan Benar">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                     ...
                     is-invalid
                     @enderror"
                                    name="name" value ="{{ old('name',$k->name)}}" 
                       ...
                       @enderror"
                                      ...
                                      name="name" value ="{{ old('kopetensi_keahlian',$k->kopetensi_keahlian)}}" 
                                    placeholder="Masukkan Keahlian Dengan Benar">
