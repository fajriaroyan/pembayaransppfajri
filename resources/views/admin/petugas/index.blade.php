                 ...
                 <div class="card">
                     <div class="card-header">
                         <a href="#" data-bs-toggle="modal" data-bs-target="#tambah"
                             class="btn btn-primary btn-sm">Tambah Petugas</a>
                     </div>
                                     ...
                                     <tr>
                                         ...
                                         <td>
                                            ...
                                            @else 
                                                ...
                                                <button class="btn btn-primary btn-sm">Siswa</button>
                                            @endif
                                         ...
                                         <td>
                                            ...
                                            <a href="#"  data-bs-toggle="modal"
                                                data-bs-target="#edit{{$u->id}}"class="btn btn-secondary btn-sm">Edit</a>
                                             <a href="#"  data-bs-toggle="modal"
                                                data-bs-target=" #delete{{$u->id}}"class="btn btn-danger btn-sm">Hapus</a>
                                            @endif
         ...
         <div class="modal-dialog">
             <div class="modal-content">
                 ...
                 <div class="modal-body">
                  ...
                  is-invalid
                  @enderror"
                                 name="name" placeholder="Masukkan Nama Dengan Benar">
                     ...
                     @enderror"
                      ...
                      @enderror"
                           ...
                           <div class="mb-3">
                               ...
                               is-invalid
                               @enderror" name="role" aria-label="Default select example">
                                   <option selected>siswa @if (Auth::user() ->role == 1)
